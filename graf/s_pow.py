...
# Form implementation generated from reading ui file 's_pow.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.title_A_3.setText(_translate("Dialog", "<html><head/><body><p align=\"center\">Введите данные:</p></body></html>"))
        self.title_A_6.setText(_translate("Dialog", "Введите скаляр a:"))
        self.pushButton_2.setText(_translate("Dialog", "Выполнить операцию"))
        self.title_A_7.setText(_translate("Dialog", "Введите степень:"))
